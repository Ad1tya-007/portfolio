...
import { getChildrenOfFolder, getFolderById, getFolderPath } from '../data/folders';
import './FolderWindow.css';

function FolderWindow({ windowId, folder, initialOffset = 0, isActive, onClose, onFocus }) {
  ...
  }, [isDragging, isResizing, isResizingSidebar, dragOffset, resizeStart, windowSize]);
  ...
  return (
    <>
      ...
      <div 
        ref={windowRef}
        className={`folder-window ${isMaximized ? 'maximized' : ''} ${isDragging ? 'dragging' : ''} ${isActive ? 'active' : ''}`}
      ...
      >
        ...
        <div className="window-title">{currentFolder?.name || folder.name}</div>
      </div>
      ...
      <div className="window-main">
        <div className="window-sidebar" style={{ width: `${sidebarWidth}px` }}>
        ...
        <div className="window-content">
          {contents.length > 0 ? (
            ...
            <div className="placeholder-content">
              ...
              <p className="placeholder-subtitle">Add content to get started</p>
            </div>
          )}
        </div>
      </div>
      ...
      {!isMaximized && (
        <>
          <div className="resize-handle resize-right" onMouseDown={handleResizeStart} />
          <div className="resize-handle resize-bottom" onMouseDown={handleResizeStart} />
          <div className="resize-handle resize-corner" onMouseDown={handleResizeStart} />
        </>
      )}
      </div>
    </>
